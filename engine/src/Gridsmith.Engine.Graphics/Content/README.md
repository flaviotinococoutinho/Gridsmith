...
|---|---|
| `SkinnedMesh.fx` | `Gridsmith.Engine.Core/Rigging/LinearBlendSkinning.cs` + `Gridsmith.Engine.Graphics/BonePacker.cs` |
| `DeferredLight.fx` | `Gridsmith.Engine.Core/Lighting/Lighting2D.cs` |
| `Composite.fx` | `Gridsmith.Engine.Core/Lighting/ColorLut.cs` |
