...
| Contrato gRPC (fonte) | `contracts/grpc/gridsmith_editor.proto` (`gridsmith.editor.v1`) |
...
| Verbosidade | `middleware/src/util/log.ts` · `frontend/src/core/logging.ts` (`GRIDSMITH_VERBOSITY`) |
